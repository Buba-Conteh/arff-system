              ...
              <div class="px-4 py-5 bg-white sm:p-6">
                <div class="grid md:grid-cols-3 gap-6">
                  ...
                  <div class="col-span-1 sm:col-span-1">
                    ...
                    <select id="country" wire:model.lazy="medium" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                      <option value="">Select Medium</option>
                      <option>Water</option>
                      <option>Carbondiocide (CO<sub>2</sub>)</option>
                      <option>Foam</option>
                      <option>Dry Chemical Powder</option>
                    </select>
                    @error('medium') <span class="error text-red-500">{{ $message }}</span> @enderror

                  </div>

                  <div class="col-span-2 sm:col-span-1">
                      <label for="country" class="block text-sm font-medium text-gray-700">Crew On Duty</label>
                      <select id="country" wire:model.lazy="crew" autocomplete="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                      ...
                      @error('crew') <span class="error text-red-500">{{ $message }}</span> @enderror
